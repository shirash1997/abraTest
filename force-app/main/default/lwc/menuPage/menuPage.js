    ...
    menuSections = [
        {
            ...
            items: [
                ...
                { id: 3, name: 'אמריקנו "גוסיפ גירל"', icon: '🗽', price: 15, description: 'קלאסי, מחוספס ומלא באופי כמו השדרה החמישית. XOXO, Gossip Girl.', image: `${CoffeeImages}/americano.jpg` },
                { id: 4, name: 'מוקה "סקס והעיר הגדולה"', icon: '👗', price: 21, description: 'שוקולד וקפה ברומן סוער יותר מהדייטים של קארי בראדשו.', image: `${CoffeeImages}/macchiato.jpg` },
                { id: 5, name: 'ריסטרטו "מגי פגש את ג׳ייק"', icon: '🎭', price: 16, description: 'חזק, קצר ומלא תשוקה כמו סיפור אהבה בלתי אפשרי.', image: `${CoffeeImages}/ristretto.jpg` },
                { id: 6, name: 'פלאט וויט "ארוחת בוקר בטיפאני׳ס"', icon: '💎', price: 20, description: 'אלגנטי, נצחי, וגורם לך לרצות ללבוש שמלת ערב ולהסתובב בניו יורק.', image: `${CoffeeImages}/flat_white.jpg` },
                { id: 7, name: 'אספרסו "מועדון ארוחת הבוקר"', icon: '☕', price: 14, description: 'אם יש משהו שמחבר בין כולם – זה אספרסו טוב בבוקר.', image: `${CoffeeImages}/espresso.jpg` },
                { id: 8, name: 'קורטדו "דירה להשכיר"', icon: '🏙️', price: 18, description: 'כוס קטנה אבל עם אופי גדול - בדיוק כמו ניו יורק של פעם.', image: `${CoffeeImages}/cortado.jpg` },
                { id: 9, name: 'מאקיאטו "החתונה של החבר שלי"', icon: '💍', price: 18, description: 'מתוק, חזק וקצת מסובך – כמו רגשות שאסור להודות בהם.', image: `${CoffeeImages}/macchiato.jpg` },
                { id: 10, name: 'קפה קר "סיפור אהבה"', icon: '❄️', price: 19, description: 'קפה קר, אבל מלא חמימות בלב – ממש כמו רגעים בלתי נשכחים.', image: `${CoffeeImages}/iced_coffee.jpg` }
            ]
        },
        {
            title: '🥐 חייב משהו בצד, לא?',
            items: [
                { id: 11, name: 'קרואסון "הרומן שלי עם אנני"', icon: '📝', price: 12, description: 'חמאה, שכבות ורגש עמוק – כמו הסצנה על גשר ברוקלין.', image: `${CoffeeImages}/croissant.jpg` },
